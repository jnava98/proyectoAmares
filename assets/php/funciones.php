...
function mostrar_formato_precontrato_vacio(){
    $html="";
    $html.='<div id="div_precontrato" class="col-lg-12">';
        $html.='<div class="card">';
            $html.='<div class="card-body">';
                $html.='<h5 class="card-title">Datos precontrato</h5>';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='</div>';
                    $html.='<div class="col-sm-2">';
                    $html.='<label for="inputDate" class="col-form-label">Fecha apartado</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-3">';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='</div>';
                    $html.='<div class="col-sm-2">';
                        $html.='<label for="inputDate" class="col-form-label">Fecha del enganche</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-3">';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='</div>';
                    $html.='<div class="col-sm-3">';
                        $html.='<input type="number" class="form-control" id="men_enganche">';
                    $html.='</div>';
                    $html.='<div class="col-sm-1">';
                    $html.='</div>';
                $html.='</div>';
                ...
                $html.='<div class="row mb-12">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label for="inputText" class="col-form-label">Clientes</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-3">';
                ...
                $html.='<div class="row mb-3">';
                    $html.='<div class="col-sm-2">';
                        $html.='<button type="button" class="btn btn-primary" onclick="guardar_datos_precontrato();">Guardar Precontrato</button>';
                    $html.='</div>';
                $html.='</div>';
            $html.='</div>';
        $html.='</div>';
