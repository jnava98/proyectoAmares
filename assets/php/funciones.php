        ...
        $html.='<div class="card">';
            $html.='<div class="card-body">';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='<div id="div_n_mensualidades" class="col-sm-1">';
                        $html.='<label for="inputText" class="col-form-label">No. de mensualidades</label>';
                    $html.='</div>';
                    $html.='<div id="n_mensualidades" class="col-sm-2">';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='</div>';
                    $html.='<div class="col-sm-2">';
                        $html.='<input type="text" class="form-control" id="nombre_descuento" value="">';
                    $html.='</div>';
                    $html.='<div class="col-sm-1">';
                        $html.='<label for="inputText" class="col-form-label">Descuento</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-2">';
                        $html.='<input type="text" id="descuento" class="form-control" onkeyup="validar_entrada(this.id)" value="">';
                    $html.='</div>';
                $html.='</div>';
                $html.='<hr>';
                $html.='<div class="row mb-12">';
