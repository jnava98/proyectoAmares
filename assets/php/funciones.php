            ...
            $html.='<div class="card-body">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Nombre</label><label style="color:red;">*</label>';
                    $html.='</div>';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Apellido Pat.</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Apellido Mat.</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Residencia</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Nacionalidad</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Correo</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label class="col-form-label">Direcci&oacute;n</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                        $html.='<input type="email" class="form-control" id="direccion_cliente">';
                    $html.='</div>';
                $html.='</div>';
                $html.='<br>';
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Tel&eacute;fono</label><label style="color:red;">*</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
                ...
                $html.='<div class="row">';
                    $html.='<div class="col-sm-2">';
                        $html.='<label>Actividad Econ&oacute;mica</label>';
                    $html.='</div>';
                    $html.='<div class="col-sm-5">';
            ...
            $html.='<div class="card-body">';
                ...
                $html.='<div class="row mb-12">';
                    ...
                    $html.='<div class="col-sm-3">';
                        $html.='<div class="row">';
                            $html.='<div class="col-sm-12">';
                                $html.='<label for="inputDate" class="col-form-label">Fecha primer pago</label><label style="color:red;">*</label>';
                            $html.='</div>';
                        $html.='</div>';
                    $html.='</div>';
                    $html.='<div class="col-sm-3">';
                        $html.='<div class="row">';
                            $html.='<div class="col-sm-12">';
                                $html.='<label for="inputText" class="col-form-label">Fecha de Entrega</label><label style="color:red;">*</label>';
                            $html.='</div>';
                        $html.='</div>';
                    $html.='</div>';
                $html.='</div>';  
                $html.='<div class="row mb-12">';
                    ...
                    $html.='<div class="col-sm-3">';
                        $html.='<div class="row">';
                            $html.='<div class="col-sm-12">';
                                $html.='<input type="date" class="form-control" id="fecha_entrega" value="">';
                            $html.='</div>';
                        $html.='</div>';
                    $html.='</div>';
                $html.='</div>';
                $html.='<br>';
                $html.='<div class="row mb-12">';
                    $html.='<p class="card-text">Datos del pago final</p>';
                    $html.='<div class="col-sm-3">';
                        $html.='<div class="row">';
                            $html.='<div class="col-sm-12">';
                    ...
                    $html.='<div class="card-body">';
                        ...
                        $html.='<div class="row mb-12">';
                            ...
                            $html.='<div class="col-sm-3">';
                                $html.='<div class="row">';
                                    $html.='<div class="col-sm-12">';
                                        $html.='<input type="date" class="form-control" id="fecha_entrega" value="'.$col['fecha_entrega'].'">';
                                    $html.='</div>';
                                $html.='</div>';
                            $html.='</div>';
                        $html.='</div>';
