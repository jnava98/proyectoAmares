    ...
    $html.='<div id="div_precontrato" class="col-lg-12">';
        $html.='<div class="card">';
            $html.='<div class="card-body">';
                ...
                $html.='<div class="row mb-3">';
                    $html.='<div class="col-sm-2">';
                        $html.='<button type="button" class="btn btn-primary" onclick="guardar_datos_precontrato();">Guardar Datos Compra</button>';
                    $html.='</div>';
                $html.='</div>';
            $html.='</div>';
        $html.='</div>';
                ...
                $html.='<div class="card">';
                    $html.='<div class="card-body">';
                        ...
                        $html.='<div class="row mb-12">';
                            ...
                            $html.='</div>';
                            $html.='<div class="col-sm-1">';
                                $html.='<label for="inputDate" class="col-form-label">Día primer pago</label>';
                            $html.='</div>';
                            $html.='<div class="col-sm-2">';
                        ...
                        $html.='<div class="row mb-12">';
                            ...
                            $html.='</div>';
                            $html.='<div class="col-sm-2">';
                                $html.='<input type="number" class="form-control" id="nombre_broker" value="'.$col['nombre_broker'].'">';
                            $html.='</div>';
                            $html.='<div class="col-sm-1">';
                        ...
                        $html.='<div class="row mb-12">';
                            $html.='<p class="card-text">Descuentos</p>';
                            $html.='<div class="col-sm-1">';
                            ...
                            $html.='</div>';
                            $html.='<div class="col-sm-1">';
                                $html.='<label for="inputText" class="col-form-label">Descuento</label>';
                            $html.='</div>';
                            $html.='<div class="col-sm-2">';
                                $html.='<input type="text" id="descuento" class="form-control" onkeyup="validar_entrada(this.id)" value="'.$col['descuento'].'">';
                            $html.='</div>';
                        $html.='</div>';
                        $html.='<hr>';
                        $html.='<div class="row mb-12">';
