...
function reporte_ingresos($fecha_uno, $fecha_dos){
	...
	$html .="
		<table id='tabla_reportes' class='table table-responsive table-bordered table-striped table-hover table-condensed dataTable no-footer'>
			<thead>
				<tr>
...
function promesas_contratos($fecha_uno, $fecha_dos){
	$html="";
	if(($fecha_uno!="0")&&($fecha_dos!="0")){
	$fecha1 = $fecha_uno; $fecha2 = $fecha_dos;
	$html.="<br>";
