...
$pdf=new FPDF();
    ...
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(180,6,utf8_decode('d) Que es voluntad de su representada celebrar el presente contrato de promesa de compraventa y obligarse en los términos establecidos en este contrato.'),0,'J',0);
    $pdf->Ln();
    ...
    $pdf->SetTextColor(0,0,0);
    $pdf->MultiCell(180,6,utf8_decode('a) Que cuenta con la capacidad jurídica y económica suficiente para obligarse y cumplir en los términos del presente contrato.'),0,'L',0);
    $pdf->Ln();
